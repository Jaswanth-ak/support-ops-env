...
"""
FastAPI application for the Support Ops Env Environment.

This module creates an HTTP server that exposes the SupportOpsEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m support_ops_env.server.app
    ...
    multiple workers:
        uvicorn support_ops_env.server.app:app --workers 4
    """
    import uvicorn
